...
public abstract class BaseFrame extends JFrame {
    ...
    protected User user; // Encapsulation: user information is protected



    // Constructor: initializes the frame with a title
    ...
    // Constructor: initializes the frame with a title and user information
    ...
    // Method: initializes the frame properties
    ...
    // Abstract Method: this method will need to be defined by subclasses when this class is being inherited from
